...
class LabMigrationProposalForm extends FormBase {
  ...
  public function buildForm(array $form, \Drupal\Core\Form\FormStateInterface $form_state) {
    ...
    if ($user->uid == 0) {
      $msg = \Drupal::messenger()->addmessage(t('It is mandatory to ' . l('login', 'user') . ' on this website to access the lab proposal form. If you are new user please create a new account first.'), 'error');
    ...
    $form['problem_statement']['ps_file'] = [
      ...
      '#size' => 48,
      '#description' => t('Only alphabets and numbers are allowed as a valid filename.') . '<br />' . t('Allowed file extensions: ') . variable_get('lab_migration_problem_statement_extensions', ''),
    ];
    $form['submit'] = [
      '#type' => 'submit',
      '#value' => t('Submit'),
